            ...
            @auth
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        {{-- Dentro de layouts/navigation.blade.php --}}
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-paragraph bg-background hover:text-primary hover:bg-gray-50 focus:outline-none transition ease-in-out duration-150">
