...
<div class="container py-5">
    <div class="mx-auto max-w-md p-8 bg-white rounded-xl shadow-lg">
        ...
        <form method="POST" action="{{ route('register.perform') }}" class="space-y-6">
            ...
            <button type="submit" class="w-full py-2 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg shadow-md transition duration-200">Cadastrar</button>
            <!-- Removido link para Painel/Dashboard -->
            <div class="text-center mt-4">
                <a href="{{ route('login') }}" class="text-sm text-gray-600 hover:text-indigo-600">Voltar ao login</a>
            </div>
        </form>
    </div>
</div>
